...
public enum EnglishPhrases {
    ...
    public static let table: [String: String] = [
        ...
        "history.stat.bestTime": "best time",
        ...
        "widget.board.cta": "Tap to start a puzzle",
        "widget.board.description": "Play your board right on your Home Screen.",
        "widget.board.name": "Playable Board",
    ...
    /// one entry per key, so **17**. (The streak/daily plurals left with the
