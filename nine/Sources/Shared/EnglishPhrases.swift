...
public enum EnglishPhrases {
    ...
    public static let table: [String: String] = [
        ...
        "board.cell.ruleSeparator": ", ",
        "board.cell.withRule": "%1$@, %2$@",
        ...
        "board.rule.cage": "cage of %1$lld",
        "board.rule.thermo": "thermometer, %1$lld of %2$lld",
        "board.stats.digitDone": "%1$lld, done",
        "board.stats.digitLeft": "%1$lld, %2$lld left",
        "board.stats.errors": "errors",
        ...
        "channel.classic.blurb": "Sudoku, as it is",
        "channel.classic.title": "Classic",
        "channel.killer.blurb": "Cages that add up",
        "channel.killer.title": "Killer",
        "channel.next": "Next channel",
        "channel.pager.label": "%1$@, page %2$lld of %3$lld",
        "channel.previous": "Previous channel",
        "channel.stats.label": "%1$@: %2$lld solved, best %3$@",
        "channel.stats.row": "%1$lld · %2$@",
        "channel.stats.title": "Your times",
        "channel.thermo.blurb": "Tubes that only rise",
        "channel.thermo.title": "Thermo",
        "channel.today.label": "%1$@ daily. %2$@",
        "channel.today.oneADay": "One a day, per channel",
        "channel.unavailable": "Needs a newer Nine",
        ...
        "coach.cageCombination.sentence": "This cage of %1$lld cells can only hold a few sets of digits, and none of the ones still possible puts a %2$lld here.",
        "coach.cageSingle.sentence": "One square of this %1$lld-cell cage is still empty, so the cage total leaves only a %2$lld.",
        ...
        "coach.innieOutie.sentence.box": "Box %1$lld sums to 45, and the cages covering it account for every square but one — so that one is a %2$lld.",
        "coach.innieOutie.sentence.col": "Column %1$lld sums to 45, and the cages covering it account for every square but one — so that one is a %2$lld.",
        "coach.innieOutie.sentence.row": "Row %1$lld sums to 45, and the cages covering it account for every square but one — so that one is a %2$lld.",
        ...
        "coach.simpleColoring.sentence.trap": "One of the two shaded groups holds every %1$lld, so no square that can see both groups can be a %1$lld.",
        "coach.simpleColoring.sentence.wrap": "Two squares in one shaded group can see each other, so that whole group is ruled out for %1$lld.",
        "coach.skyscraper.sentence": "These two lines each hold %1$lld in only two squares, and they share one. So one of the far ends is a %1$lld, and nothing seeing both can be.",
        ...
        "coach.swordfish.sentence.colBase": "In these three columns, %1$lld can only sit in three rows, so no other square in those rows can be a %1$lld.",
        "coach.swordfish.sentence.rowBase": "In these three rows, %1$lld can only sit in three columns, so no other square in those columns can be a %1$lld.",
        "coach.thermoBound.sentence": "Digits rise from the bulb to the tip of this %1$lld-cell thermometer, which puts a floor and a ceiling on every square along it.",
        ...
        "coach.xyWing.sentence": "The ringed square is %1$lld or %2$lld, and either way one of its two partners becomes a %3$lld. So nothing seeing both partners can be a %3$lld.",
        "debrief.close": "Hide your solve",
        "debrief.corrections": "%1$lld corrections",
        "debrief.duel.cleared": "%1$@ cleared %2$lld digits",
        "debrief.duel.last": "%1$@ placed the last digit.",
        "debrief.duel.placed": "%1$@ placed %2$lld digits",
        "debrief.duel.separator": " · ",
        "debrief.empty": "Nothing to replay",
        "debrief.errors": "%1$lld errors",
        "debrief.fastest": "Fastest region · %1$@",
        "debrief.headline": "You found the %1$@ at move %2$lld",
        "debrief.longest": "Longest circled · %1$@",
        "debrief.notes": "%1$lld notes",
        "debrief.open": "Show your solve",
        "debrief.placements": "%1$lld digits placed",
        "debrief.replay": "Replay",
        "debrief.title": "Your solve",
        "difficulty.abyss.blurb": "One digit, two colours",
        "difficulty.abyss.explainer": "Colour one digit's forced pairs two ways until a colour breaks. The deepest board Nine will make.",
        "difficulty.abyss.title": "Abyss",
        ...
        "difficulty.tempest.blurb": "Wings & swordfish",
        "difficulty.tempest.explainer": "Needs a pattern spread across three lines: a swordfish, a skyscraper, an XY-wing. The X-wing family, grown up.",
        "difficulty.tempest.title": "Tempest",
        ...
        "firstrun.ledger.proof": "Every board proved solvable by logic, never by guessing",
        ...
        "history.section.table": "The Table",
        ...
        "menu.board.autoNotes": "Auto Notes",
        "menu.board.erase": "Erase",
        "menu.board.hint": "Show a Hint",
        "menu.board.nextEmpty": "Next Empty Cell",
        "menu.board.pencil": "Pencil",
        "menu.board.previousEmpty": "Previous Empty Cell",
        "menu.board.title": "Board",
        "menu.board.why": "Why Must This Be…?",
        "menu.edit.undo": "Undo",
        ...
        "menu.view.menuBar": "Nine in the Menu Bar",
        "menu.view.numberHighlight": "Number Highlight",
        "menu.view.showTimer": "Show Timer",
        "parlor.activity.subtitle": "The same board, everyone on their own",
        "parlor.activity.title": "Nine together",
        "parlor.challenge": "Send this board",
        "parlor.comet.other": "Someone else · %1$@",
        "parlor.comet.you": "You · %1$@",
        "parlor.dot.finished": "Finished",
        "parlor.dot.other": "Someone else",
        "parlor.dot.progress": "%1$lld of %2$lld filled",
        "parlor.dot.you": "You",
        "parlor.invite.accepted": "Same board as your friend",
        "parlor.sideBySide": "Side by side",
        "parlor.start.caption": "On a FaceTime call, everyone gets this board",
        "parlor.start.title": "Play together",
        ...
        "prefs.livePresence.title": "Lock Screen board",
        ...
        "prefs.toggle.on": "On",
        "presence.glyph.label": "%1$lld squares filled",
        "presence.header": "Today's board",
        "presence.remaining": "%1$lld squares to go",
        "school.action.gotIt": "Got it",
        "school.action.showMe": "Show me",
        "school.close": "Close",
        "school.lesson.done": "That is a %1$@. You will meet it again.",
        "school.lesson.look": "Somewhere on this board, one square is settled. Look first.",
        "school.row.met": "%1$@, met",
        "school.row.new": "%1$@, not yet met",
        "school.subtitle": "One lesson for each way a board can be read.",
        "school.title": "Technique School",
        "share.button": "Share",
        ...
        "shelf.channel.daily": "%1$@ · %2$@",
        "shelf.channel.free": "%1$@ · %2$@",
        ...
        "stats.techniquesMet": "%1$lld of %2$lld techniques met",
        "status.composing": "Composing…",
        "status.solved": "Solved",
        "table.invitation": "Twenty players, one week. The days you finish count first; your time breaks the tie.",
        "table.join": "Join the table",
        "table.leave": "Leave the table",
        "table.leave.note": "Leaving stops new scores. What has already gone up stays until the week ends.",
        "table.seat.label": "%1$@, %2$lld of 7 days, %3$@",
        "table.seat.mine": "You, %1$lld of 7 days, %2$@",
        "table.waiting": "Nothing here yet this week.",
        "table.you": "You",
        ...
        "technique.simpleColoring.name": "Coloring",
        "technique.skyscraper.name": "Skyscraper",
        "technique.swordfish.name": "Swordfish",
        "technique.thermoBound.name": "Thermometer Bound",
        "technique.xWing.name": "X-Wing",
        "technique.xyWing.name": "XY-Wing",
        "theme.auto": "Auto",
        ...
        "variantTier.gentle.title": "Gentle",
        "variantTier.sharp.title": "Sharp",
        "variantTier.steady.title": "Steady",
        "watch.app.name": "Nine",
        ...
        "why.action.next": "Next",
        "why.beyond.sentence": "Nothing at this board's level settles this square yet.",
        "why.beyond.title": "Not from here",
        "why.effect.leaves": "That leaves only the %1$lld.",
        "why.effect.rulesOutMore": "That clears several more possibilities from this square.",
        "why.effect.rulesOutOne": "That rules the %1$lld out of this square.",
        "why.effect.rulesOutTwo": "That rules the %1$lld and the %2$lld out of this square.",
        "why.elsewhere": "Other squares had to be settled first.",
        "why.heading": "Why must this be %1$lld?",
        "why.position": "%1$lld of %2$lld",
        "why.untold": "Earlier steps are not shown.",
    ...
    public static let plurals: [String: EnglishPlural] = [
        ...
        "debrief.corrections": EnglishPlural(count: 1, one: "%1$lld correction"),
        "debrief.duel.cleared": EnglishPlural(count: 2, one: "%1$@ cleared %2$lld digit"),
        "debrief.duel.placed": EnglishPlural(count: 2, one: "%1$@ placed %2$lld digit"),
        "debrief.errors": EnglishPlural(count: 1, one: "%1$lld error"),
        "debrief.notes": EnglishPlural(count: 1, one: "%1$lld note"),
        "debrief.placements": EnglishPlural(count: 1, one: "%1$lld digit placed"),
        ...
        "presence.glyph.label": EnglishPlural(count: 1, one: "%1$lld square filled"),
        "presence.remaining": EnglishPlural(count: 1, one: "%1$lld square to go"),
