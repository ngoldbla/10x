...
// tvos/<app>/Assets.xcassets. Pure CoreGraphics; run on macOS:
//
//   swift tvos/scripts/generate_brand_assets.swift            # all five apps
//   swift tvos/scripts/generate_brand_assets.swift nine       # one app
//
...
let tvosDir = scriptDir.deletingLastPathComponent()
...
for s in selected {
    let catalog = tvosDir.appendingPathComponent("\(s.folder)/Assets.xcassets")
