...
**Status:** Draft v1 · **Thread:** `tvos/cartridge/` · **Remote-fit:** 8/10 (shell 10, per-game 6–9)
...
AI game-generator (10x-style spec loop + verifier) is the documented v2 that this
